...
<%	  
	...
	{  
       ...
       PreparedStatement pst=con.prepareStatement("update Renter_DB set Photo=? where OwnerEmail=? and RenterEmail=?");
        pst.setString(1,filename2);
        pst.setString(2,(String)session.getAttribute("email"));
				pst.setString(3,request.getParameter("renter_email"));
        pst.executeUpdate();
        con.close(); 
